...
<head>
	...
	<title>Muhammad Angga Oktaharisetia</title>
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
	<meta name="keywords" content="Muhammad Angga Oktahariseta" />
	<meta name="author" content="muhanggaohs" />
		...
		<div class="container opened" data-animation-in="fadeInLeft" data-animation-out="fadeOutLeft">
			...
			<div class="card-started" id="home-card">
				...
				<div class="profile no-photo">
					...
					<!-- profile titles -->
					<div class="title"><font style="font-size: 20px;">Muhammad Angga Oktaharisetia</font></div>
					<div class="subtitle"><b>System Specialist & Software Engineer</b></div>
					...
					<!-- profile buttons -->
					<div class="lnks">
						<a href="https://drive.google.com/file/d/1K3BKBwjiefDcLR47QEaoHU-J6y3KQwoP/view?usp=sharing" class="lnk" download="Download CV" target="new">
					...
					<div class="content about">
						...
						<div class="row">
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="text-box">
									<p>
										I am Muhammad Angga Oktaharisetia, system specialist and software engineer from IDN, Palembang. I have rich experience in 
										developing many apps like Information System, Websites, etc. 
										For more information, let us take a look at my resume.
									</p>
								</div>
							</div>
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="info-list">
									<ul>
										...
										<li><strong>Address . . . . .</strong> Palembang, IDN</li>
									</ul>
								</div>
							</div>
							<div class="clear"></div>
				...
				<div class="card-wrap">
					...
					<div class="content works">
						...
						<div class="filter-menu filter-button-group">
							...
							<div class="f_btn">
								<label><input type="radio" name="fl_radio" value="mobile" />Mobile App</label>
							</div>
							<div class="f_btn">
								<label><input type="radio" name="fl_radio" value="video" />Web App</label>
							</div>
						</div>
			...
			<div class="card-inner contacts" id="contacts-card">
				<div class="card-wrap">
					...
					<div class="content contacts">
						...
						<div class="row">
							<div class="col col-d-12 col-t-12 col-m-12 border-line-v">
								<div class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127504.44544246563!2d104.69292380322271!3d-2.9547949057905565!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e3b75e8fc27a3e3%3A0x3039d80b220d0c0!2sPalembang%2C%20Palembang%20City%2C%20South%20Sumatra!5e0!3m2!1sen!2sid!4v1601735250369!5m2!1sen!2sid" width="100%" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></div>
							</div>
							<div class="col col-d-12 col-t-12 col-m-12 border-line-v">
								<div class="info-list">
									<ul>
										<li><strong>Address . . . . .</strong> Palembang, IDN</li>
										<li><strong>Email . . . . .</strong> nggaproj@gmail.com</li>
										<li><strong>Phone . . . . .</strong> +62 821-7574-7308</li>
										<li><strong>Freelance . . . . .</strong> Available</li>
									</ul>
								</div>
							</div>
...
<!-- Mirrored from bslthemes.com/ryan/demo/index-new-no-photo.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Sep 2020 06:43:56 GMT -->
</html>	